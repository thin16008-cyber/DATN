...
public class AIController {
    ...
    public List<QuestionDTO> generateQuestionsByUser(Authentication authentication) {
        ...
        if (!flashCardsList.isEmpty()) {
            ...
            promptBuilder.append("Hãy tạo các câu hỏi trắc nghiệm tiếng Anh dựa trên danh sách từ vựng sau:\n");
            for (String entry : wordMeaningList) {
                promptBuilder.append("- ").append(entry).append("\n");
            }
            promptBuilder.append("""
        Tạo ra đúng 10 câu hỏi trắc nghiệm tiếng Anh dựa trên từ vựng sau:
    ...
    public String evaluateAnswers(@RequestBody UserAnswerAIDTO request) {
        ...
        prompt.append("""
        Bạn là một giáo viên chấm bài thi tiếng Anh.
        ...
        prompt.append("""
                Hãy trả kết quả theo định dạng:
                {
                  ...
                  1. Đánh giá trình độ hiện tại (ví dụ: bạn đang ở khoảng Band 6.0 - 6.5 hoặc toeic 450 - 650+).
    ...
    public Map<String, String> translateJapaneseToVietnamese(@RequestBody Map<String, String> request) {
        ...
        String prompt = """
        Bạn là giáo viên dạy tiếng Anh. Bạn hãy đưa ra câu trả lời một cách trôi chảy liền mạch. Vào đầu câu trả lời sẽ có chào bạn..
        Dịch câu tiếng Anh sau sang tiếng Việt. Nếu là câu hỏi thì hãy dịch sao cho người học dễ hiểu.
